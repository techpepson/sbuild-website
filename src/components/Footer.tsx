      ...
      <div className="container px-4 py-16 mx-auto max-w-7xl">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center text-sbuild hover:bg-sbuild hover:text-white transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 flex space-x-6">
            <Link to="/privacy" className="text-sm text-muted-foreground hover:text-sbuild">
              Privacy Policy
            </Link>
            <Link to="/terms" className="text-sm text-muted-foreground hover:text-sbuild">
              Terms of Service
            </Link>
            <Link to="/cookie-policy" className="text-sm text-muted-foreground hover:text-sbuild">
              Cookie Policy
            </Link>
          </div>
        </div>
