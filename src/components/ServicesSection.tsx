...
import { ArrowRight, Code, Cloud, Globe, Palette, LifeBuoy, Zap } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: "Tailor-made SaaS applications designed to meet your specific business requirements and goals.",
      ...
      <div className="container px-4 mx-auto max-w-7xl">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            We offer a comprehensive suite of services designed to help businesses develop, 
            deploy, and optimize SaaS solutions that drive growth and efficiency.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="mb-3 text-xl font-display font-semibold">{service.title}</h3>
              <p className="mb-6 text-muted-foreground">{service.description}</p>
              
              <a href={`/services#${service.id}`} className="inline-flex items-center text-sbuild hover:underline">
