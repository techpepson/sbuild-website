...
const Stats = () => {
  ...
  const stats = [
    { value: '50+', label: 'Successful Projects', gradient: 'gradient-teal' },
    { value: '20+', label: 'Industry Partnerships', gradient: 'gradient-purple' },
    { value: '100K+', label: 'Users Benefiting', gradient: 'gradient-blue' },
    { value: '98%', label: 'Client Satisfaction Rate', gradient: 'gradient-orange' },
  ];
