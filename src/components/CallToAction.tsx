...
const CallToAction = () => {
  ...
  return <section id="contact" ref={ref} className="py-20 relative overflow-hidden">
      ...
      <div className="container px-4 mx-auto max-w-7xl">
        <div className={cn("bg-white/80 backdrop-blur-md p-8 md:p-12 rounded-2xl relative overflow-hidden border border-teal-100 max-w-5xl mx-auto", "transition-all duration-700 transform", inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10")}>
          {/* Decorative elements */}
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link to="/contact">
                <Button variant="outline" className="h-12 px-8 border-gray-200 rounded-lg hover:bg-gray-100">
