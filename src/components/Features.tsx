  ...
  const features = [
    {
      ...
      description:
        "Built on a robust peer-to-peer network that ensures reliability and resistance to censorship and downtime.",
    },
    {
      icon: <Shield className="h-6 w-6 text-accent" />,
      title: "Enhanced Security",
      description:
        "End-to-end encryption and cryptographic protocols protect your data and communications from unauthorized access.",
    },
    {
      icon: <Users className="h-6 w-6 text-accent" />,
      title: "Community Governance",
      description:
        "Platform decisions are made collectively by users, fostering transparency and democratic participation.",
    },
    {
      icon: <Key className="h-6 w-6 text-accent" />,
      title: "Self-Sovereign Identity",
      description:
        "Control your digital identity without relying on centralized authorities or exposing personal information.",
    },
    {
      icon: <Upload className="h-6 w-6 text-accent" />,
      title: "Seamless Integration",
      description:
        "Easily connect with existing tools and platforms through our comprehensive API and developer resources.",
    },
    {
      icon: <Download className="h-6 w-6 text-accent" />,
      title: "Data Portability",
      description:
        "Export your data at any time in standard formats, ensuring you're never locked into the platform.",
    },
  ];
  ...
  return (
    <section id="features" className="py-20 md:py-32 relative overflow-hidden">
      ...
      <div className="container px-6 md:px-10 mx-auto max-w-7xl">
        <div ref={sectionRef} className="text-center mb-16 max-w-3xl mx-auto">
          <div
            className={cn(
          ...
          >
            Our platform reimagines what's possible with decentralized
            technology, putting control back in your hands while maintaining
            elegant simplicity.
          </p>
        </div>
