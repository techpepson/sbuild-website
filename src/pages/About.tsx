...
import { ArrowRight, Building, Users, Target, Award, CheckCircle2 } from 'lucide-react';
  ...
  const values = [
    {
      ...
      title: "Innovation",
      description: "We constantly pursue new ideas and approaches to solve complex business challenges.",
      color: "text-sbuild",
    ...
    },
    {
      ...
      title: "Collaboration",
      description: "We believe in working closely with our clients to ensure their success.",
        ...
        <section ref={heroRef} className="py-12 md:py-16 relative overflow-hidden">
          ...
          <div className="container px-4 mx-auto max-w-7xl">
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                Building the Future of <span className="text-sbuild">SaaS Technology</span>
              </h1>
              <p 
                className={cn(
              ...
              >
                SBuild Solutions is a leading SaaS development company specializing in cutting-edge solutions
                that enhance productivity, efficiency, and security for businesses worldwide.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  Founded in 2018, SBuild Solutions was born out of a vision to make powerful SaaS technology accessible 
                  to businesses of all sizes. We recognized that many organizations struggle with outdated systems that 
                  hamper growth and operational efficiency.
                </p>
                <p className="text-lg text-muted-foreground mb-6">
                  What began as a small team of passionate developers has grown into a full-service SaaS development 
                  company with a global client base. Throughout our journey, we've remained committed to our core 
                  mission: delivering innovative software solutions that solve real business challenges.
                </p>
        ...
        <section ref={valuesRef} className="py-16 md:py-24">
          <div className="container px-4 mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              >
                These principles guide every decision we make and every line of code we write, ensuring we deliver 
        ...
        <section ref={teamRef} className="py-16 md:py-24 bg-gray-50">
          <div className="container px-4 mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              >
                Our diverse team brings together years of experience in software development, design, and business strategy.
              </p>
            </div>
